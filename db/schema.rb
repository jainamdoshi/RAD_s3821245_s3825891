...
ActiveRecord::Schema.define(version: 2021_05_23_162454) do
  ...
  create_table "checkouts", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cart_items_id", "user_id", "purchased_time"], name: "index_checkouts_on_cart_items_id_and_user_id_and_purchased_time", unique: true
  end
  ...
  create_table "product_tags_products", id: false, force: :cascade do |t|
    ...
    t.integer "product_id", null: false
    t.index ["product_tag_id", "product_id"], name: "index_product_tags_products_on_product_tag_id_and_product_id", unique: true
  end
  ...
  create_table "ratings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_ratings_on_user_id", unique: true
  end
